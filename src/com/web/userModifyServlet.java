...
public class userModifyServlet extends HttpServlet{
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		out.println("");
		out.println("\"><img src=\"./images/logo.gif\" width=\"286\" height=\"58\"></td>");
		out.println("				<td width=\"62%\" background=\"./images/top_bg.gif\">　</td>");
		out.println("				<td width=\"31%\" background=\"./images/top_bg.gif\" align=");
		out.println("");
		out.println("\"right\"><img src=\"./images/top_r.gif\" width=\"352\" height=\"58\" border=\"0\"></td>");
		out.println("			</tr>");
		out.println("		</table>");
		out.println("		<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">");
		out.println("");
		out.println("			<tr>");
		out.println("				<td background=\"./images/dh_bg.gif\" align=\"left\" height=");
		out.println("");
		out.println("\"12\">");
		out.println("					<table width=\"100\" border=\"0\" cellspacing=\"0\" ");
		out.println("");
		out.println("cellpadding=\"0\" align=\"center\">");
		out.println("						<tr>");
		...
		out.println("			<tr>");
		out.println("				 <td colspan=\"2\" align=\"center\" valign=\"middle\" background=");
		out.println("");
		out.println("\"./images/bg2.gif\" width=\"60%\"> &nbsp;&nbsp;<font><b>用户信息修改</b></font> ");
		out.println("   				 </td>");
		out.println("			<tr>");
		out.println("			<tr>");
		out.println("				<td width=\"40%\" class=\"tablebody1\"><b>用户名</b>：<br>英文字母或数");
		out.println("");
		out.println("字，最大长度为8位</td>");
		out.println("				<td width=\"60%\" class=\"tablebody1\">");
		out.println("				<input type=\"text\" maxLength=\"12\" size=\"32\"  value=\"tarena\" ");
		out.println("");
		out.println("style=\"font-family: Tahoma,Verdana,宋体; font-size: 12px; line-height: 15px; color: #000000\"/>");
		out.println("				<font color=\"#FF0000\">*</font></td>");
		out.println("			</tr>");
		out.println("			<tr>");
		out.println("				<td width=\"40%\" class=\"tablebody1\"><b>密码</b>：<br>数字，6到8位");
		out.println("");
		out.println("</td>");
		out.println("				<td width=\"60%\" class=\"tablebody1\">");
		out.println("				<input type=\"password\" maxLength=\"12\" size=\"32\" name=\"password");
		out.println("");
		out.println("\" value=\"tarena\" style=\"font-family: Tahoma,Verdana,宋体; font-size: 12px; line-height: 15px; ");
		out.println("");
		out.println("color: #000000\"/>");
		out.println("				<font color=\"#FF0000\">*</font></td>");
		out.println("			</tr>");
		out.println("			<tr>");
		out.println("				<td width=\"40%\" class=\"tablebody1\"><b>确认密码</b>：<br>数字，6到8");
		out.println("");
		out.println("位</td>");
		out.println("				<td width=\"60%\" class=\"tablebody1\">");
		out.println("				<input type=\"password\" maxLength=\"12\" size=\"32\" name=");
		out.println("");
		out.println("\"password2\" value=\"tarena\" style=\"font-family: Tahoma,Verdana,宋体; font-size: 12px; line-height: ");
		out.println("");
		out.println("15px; color: #000000\"/>");
		out.println("				<font color=\"#FF0000\">*</font></td>");
		out.println("			</tr>");
		out.println("			<tr>");
		out.println("				<td width=\"40%\" class=\"tablebody1\"><b>所在地区</b>：</td>");
		out.println("				<td width=\"60%\" class=\"tablebody1\">");
		out.println("					<select name=\"country\" onchange=\"javascript:initProvince");
		out.println("");
		out.println("(this.value)\" style=\"font-family: Tahoma,Verdana,宋体; font-size: 12px; line-height: 15px; color: ");
		out.println("");
		out.println("#000000\">");
		...
		out.println("					</select>");
		out.println("					<select name=\"province\" style=\"font-family: Tahoma,Verdana,");
		out.println("");
		out.println("宋体; font-size: 12px; line-height: 15px; color: #000000\">");
		out.println("               		  	");
		...
		out.println("				<input type=\"text\" size=\"8\" name=\"city\" value=\"黄埔\" style=");
		out.println("");
		out.println("\"font-family: Tahoma,Verdana,宋体; font-size: 12px; line-height: 15px; color: #000000\"/>市/县</td>");
		out.println("			</tr>");
		out.println("			<tr>");
		out.println("				<td class=\"tablebody1\"><b>联系地址1</b>：</td>");
		out.println("				<td class=\"tablebody1\">");
		out.println("				<input type=\"text\" size=\"64\" maxlength=\"32\" name=\"street1\" ");
		out.println("");
		out.println("value=\"北京东路668号B区901\" style=\"font-family: Tahoma,Verdana,宋体; font-size: 12px; line-height: ");
		out.println("");
		out.println("15px; color: #000000\"/>");
		out.println("			</td>");
		out.println("			<tr>");
		...
		out.println("				<td class=\"tablebody1\">");
		out.println("				<input type=\"text\" size=\"64\" maxlength=\"32\" name=\"street2\" ");
		out.println("");
		out.println("style=\"font-family: Tahoma,Verdana,宋体; font-size: 12px; line-height: 15px; color: #000000\"/>");
		out.println("			</td>");
		out.println("			<tr>");
		...
		out.println("");
		out.println("\"200001\" style=\"font-family: Tahoma,Verdana,宋体; font-size: 12px; line-height: 15px; color: ");
		out.println("");
		out.println("#000000\"/>");
		out.println("			</td>");
		out.println("			<tr>");
		...
		out.println("				<td class=\"tablebody1\">");
		out.println("				<input type=\"text\" size=\"32\" maxlength=\"16\" name=\"homephone\" ");
		out.println("");
		out.println("value=\"61202663\" style=\"font-family: Tahoma,Verdana,宋体; font-size: 12px; line-height: 15px; ");
		out.println("");
		out.println("color: #000000\"/>");
		out.println("			</td>");
		out.println("			<tr>");
		...
		out.println("				<td class=\"tablebody1\">");
		out.println("				<input type=\"text\" size=\"32\" maxlength=\"16\" name=\"officephone\" ");
		out.println("");
		out.println("value=\"61202663\" style=\"font-family: Tahoma,Verdana,宋体; font-size: 12px; line-height: 15px; ");
		out.println("");
		out.println("color: #000000\"/>");
		...
		out.println("				<input type=\"text\" size=\"32\" maxlength=\"16\" name=\"officephone\" ");
		out.println("");
		out.println("value=\"13211161676\" style=\"font-family: Tahoma,Verdana,宋体; font-size: 12px; line-height: 15px; ");
		out.println("");
		out.println("color: #000000\"/>");
		out.println("			</td>");
		out.println("			<tr>");
		...
		out.println("");
		out.println("\"wawawa115@sina.com\" style=\"font-family: Tahoma,Verdana,宋体; font-size: 12px; line-height: 15px; ");
		out.println("");
		out.println("color: #000000\"/></td>");
		out.println("			</tr>");
		out.println("			<tr>");
