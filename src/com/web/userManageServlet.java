...
public class userManageServlet extends HttpServlet{
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		try{
			UserManagerServiceImpl usermanagerserviceimpl = new UserManagerServiceImpl();
			
			List userList = usermanagerserviceimpl.getUserList();
	...
	private void toUserList(HttpServletResponse resp, List userList)
		...
		for(Iterator<usermanager> it = userList.iterator();it.hasNext();){
			
			usermanager user = it.next();
			...
			out.println("				<td class=tablebody2 valign=\"middle\" align=\"center\" height=\"25\"  width=\"35%\">");
			out.println("					");
			out.println("						<input type=\"button\" value=\"修改\" onclick=\"javascript:window.location='./userModifyServlet';\" /> ");
