...
public class productDetailServlet extends HttpServlet{
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		try{
			ProductDetailServiceImpl ProductDetailService = new ProductDetailServiceImpl();
				
			List ProductDetail= ProductDetailService.getProductDetail("2");

			toProductDetail(resp, ProductDetail);
		} catch (Exception e){
	...
	private void toProductDetail(HttpServletResponse resp, List ProductDetail)
			throws IOException {
	...
	for(Iterator<productdetail> it = ProductDetail.iterator();it.hasNext();){
		//for(int i=0;i<1;i++){
			//ProductDetail.get(i);
			productdetail pro =it.next();
		out.println("			<tr>");
		...
		out.println("				");
		out.println("				<td class=tablebody1 valign=\"middle\" width=\"75%\">");
		out.println("				"+ pro.getCdescription()+"<br>");
		out.println("				</td>");
		out.println("			</tr>");
		out.println("			<tr>");
		...
		out.println("				");
		out.println("				<td class=tablebody1 valign=\"middle\" width=\"75%\">");
		out.println("				"+ pro.getPdescription()+"<br>　　");
		out.println("				</td>");
		out.println("			</tr>");
		out.println("			<tr>");
