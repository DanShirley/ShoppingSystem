...
public class OrderServlet extends HttpServlet{
	...
	private void toOrderDetailUserList(HttpServletResponse resp, List orderDetailUserList,List orderDetailPayList)
		...
		out.println("				");
		out.println("    			<td class=tablebody1 valign=\"middle\" width=\"60%\"> ");
		out.println("    			"+orderdetailuser.getCountry()+" "+orderdetailuser.getProvince()+"省 "+orderdetailuser.getCity()+"市 "+orderdetailuser.getStree1()+" ("+orderdetailuser.getStreet2()+")");
		...
		for(Iterator<orderdetailqingdan> it = orderDetailQingdanList.iterator();it.hasNext();){
		    ...
		    out.println("    			价格："+orderdetailqingdan.getBasePrice());
		    out.println("    			</td>");
		    out.println("    			<td class=tablebody1 valign=\"middle\" align=\"center\" width=\"14%\"> ");
		    out.println("    			数量："+orderdetailqingdan.getAmount());
		    out.println("    			</td>");
		    out.println("    			<td class=tablebody2 valign=\"middle\" width=\"25%\"> ");
		    out.println("    			小计："+orderdetailqingdan.getAllPrice());
		    out.println("    			</td>");
		    out.println("			</tr>");
		    out.println("			");
		...
		out.println("    			合计：<font color=\"red\"><b>"+sum+"</b><font>");
		out.println("    			</td>");
		out.println("			</tr>");
		out.println("		</table>");
		out.println("		<br>");
